...
const { authenticate, upload, generateAvatar, fileExists } = require("../../middlewares");
...
router.patch("/avatars", authenticate, fileExists, upload.single("avatar"), errorWrapper(authController.avatar));
